	...
	public class ToeFain implements ActionListener{
	...
	*/
	...
	toeWindow.setBackground(Color.CYAN);
	toeWindow.setLayout(bl);
	topPanel.add(newGameButton);
	toeWindow.add(topPanel,"North");
	JPanel centerPanel=new JPanel();
	centerPanel.setLayout(new GridLayout(3,3));
	toeWindow.add(centerPanel,"Center");
	score=new Label("Your turn!");
	toeWindow.add(score,"South");
